...
namespace Turnos.Controllers
{
    public class MedicoController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var medico = await _context.Medico.Where(m => m.IdMedico == id).Include(me => me.MedicoEspecialidad)
        ...
        public async Task<IActionResult> Create([Bind("IdMedico,Nombre,Apellido,Direccion,Email,HorarioAtencionDesde,HorarioAtencionHasta")] Medico medico, int IdEspecialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMedico,Nombre,Apellido,Direccion,Email,HorarioAtencionDesde,HorarioAtencionHasta")] Medico medico, int IdEspecialidad)
        {
        ...
        {
            var HorarioAtentionDesde = _context.Medico.Where(m => m.IdMedico == idMedico).FirstOrDefault().HorarioAtencionDesde;
            return HorarioAtentionDesde.Hour + ":" + HorarioAtentionDesde.Minute;
        }

        public string TraerHorarioAtencionHasta (int idMedico)
        {
            var HorarioAtentionHasta = _context.Medico.Where(m => m.IdMedico == idMedico).FirstOrDefault().HorarioAtencionHasta;
            return HorarioAtentionHasta.Hour + ":" + HorarioAtentionHasta.Minute;
        }
    }
